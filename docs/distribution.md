...
- Version output is not `0.9.0`: uninstall stale local installs with `python -m pip uninstall earnings-call-risk-map` or `pipx uninstall earnings-call-risk-map`, then reinstall from the checkout.
