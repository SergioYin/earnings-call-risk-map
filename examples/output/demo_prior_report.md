...
- None detected by deterministic keyword rules.

## Opportunities

- **Net retention**: 5 (medium), `current`
  Evidence: https://example.com/exm/q4-2025-deck
- **revenue durability**: 5 (medium), `current`
  Evidence: https://example.com/exm/q4-2025-call
- **gross margin**: 4 (medium), `current`
  Evidence: https://example.com/exm/q4-2025-deck
...
- `2026-05-15` **Q1 earnings review** (opportunity validation): Compare pipeline comments with reported growth.
