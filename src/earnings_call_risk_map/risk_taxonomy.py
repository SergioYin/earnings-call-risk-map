"""Risk language taxonomy artifact rendering."""

from __future__ import annotations


def risk_language_taxonomy_markdown(scoring_link: str, source_attribution_link: str) -> str:
    lines = [
        ...
        "",
        f"See [Scoring]({scoring_link}) for the implementation-level calibration and [Source Attribution Guide]({source_attribution_link}) for provenance boundaries.",
        "",
